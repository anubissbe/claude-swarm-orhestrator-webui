...
export const LoadingSpinner = (props: React.SVGProps<SVGSVGElement>) => (
    <svg className="animate-spin h-6 w-6 text-cyan-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
...
export const ExclamationCircleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-rose-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export const HexagonIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M21 16.5C21 17.38 20.62 18.21 20 18.71L13 22.21C12.38 22.62 11.62 22.62 11 22.21L4 18.71C3.38 18.21 3 17.38 3 16.5V7.5C3 6.62 3.38 5.79 4 5.29L11 1.79C11.62 1.38 12.38 1.38 13 1.79L20 5.29C20.62 5.79 21 6.62 21 7.5V16.5Z" />
    </svg>
);
...
export const CenterFocusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const GraphIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.875-1.975l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47A3 3 0 0015 8z" />
    </svg>
);
